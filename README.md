...
Firmware documentation is collected and maintained in the <a href="https://github.com/breakintoprogram/agon-docs/wiki">Agon light™ WiKi</a>. Because the Wiki is now the reference documentation, the 'Firmware Installation Guide' and the 'Quick Start Guide' above are obsolete and kept here just for legacy reasons.<br><p>
